...
<script src="{{ asset('packages/rydurham/sentinel/js/jquery-2.1.3.min.js') }}"></script>
	<!-- If you are using CSS version, only link these 2 files, you may add app.css to use for your overrides if you like. -->
  	<link rel="stylesheet" href="{{ asset('assets/bootstrap-datepicker/css/datepicker.css') }}">   
  ...
  <script src="{{ asset('ckeditor/samples/css/samples.css') }}"></script>
...
<link rel="stylesheet" href="{{ asset('packages/rydurham/sentinel/css/normalize.css') }}">
  ...
  <section id="container" >
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li><a href="{{ url('/role/') }}"><i class="fa fa-tags"></i> Roles</a></li>
                            @endif
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
					...
					<li {{ (Request::is('users*') ? 'class="active"' : '') }} >
						<a href="{{ url('/users/') }}" @if(Request::is('users*')) {{'class=active'}} @else '' @endif>
					...
					<li {{ (Request::is('users*') ? 'class="active"' : '') }}>
						<a href="{{ url('/application/') }}"  @if(Request::is('application*')) {{'class=active'}} @else '' @endif><i class="fa fa-tags"></i> Maid Application</a>
					</li>
					<li {{ (Request::is('users*') ? 'class="active"' : '') }}>
					...
					<li class="sub-menu">
                      <a href="javascript:;"  @if(Request::is('servicefees*') || Request::is('service*')) {{'class=active'}} @else '' @endif>
							<i class="fa fa-cogs"></i><span>Forms Settings</span>
					  </a>
					  <ul class="sub">
                <li class="sub-menu"> <a href="{{ url('/service/') }}" href="javascript:;" <?php if(isset($_REQUEST['mode'])){echo "class='active'"; }?>>Services & Fee Schedule</a>
					<ul >
                    <li <?php if(isset($_REQUEST['mode']) && $_REQUEST['mode'] == 'newtransfer'){echo "class='active'"; }?> ><a  href="{{ url('/service/?mode=newtransfer') }}">New/Transfer Service</a></li>
                    <li <?php if(isset($_REQUEST['mode']) && $_REQUEST['mode'] == 'replacement'){echo "class='active'"; }?>><a  href="{{ url('/service/?mode=replacement') }}">Replacement Service</a></li> 
					</ul> </li>
					
				   <li <?php if(isset($_REQUEST['agreementform*'])) {echo "class='active'"; }?>><a  href="{{ url('/agreementform/') }}"  <?php if(isset($_REQUEST['agreementform*'])) {echo "class='active'"; }?>>Agreement Forms</a>
          ...
          <li {{ (Request::is('package*') ? 'class="active"' : '') }} ><a  href="{{ url('/package/') }}"  <?php if(isset($_REQUEST['package*'])) {echo "class='active'"; }?>> <i class="fa fa-tags"></i>Packages Fee</a></li>
         
					<li class="sub-menu">
                      <a href="javascript:;"  @if(Request::is('invoiceList*') || Request::is('service*')) {{'class=active'}} @else '' @endif>
              <i class="fa fa-tags"></i><span>Payment</span>
            </a>
            <ul class="sub">
                  
          <!-- <li <?php if(isset($_REQUEST['agreementform*'])) {echo "class='active'"; }?>> Invoice
          </li>-->
           <li class="sub-menu"> <a href="#">Invoices</a>
          <ul >
                    <li <?php if(isset($_REQUEST['invoiceList']) && $_REQUEST['invoiceList'] == 'employer'){echo "class='active'"; }?> ><a  href="{{ url('/invoiceList/employer') }}">Employer invoice</a></li>
                    <li <?php if(isset($_REQUEST['invoiceList']) && $_REQUEST['invoiceList'] == 'maid'){echo "class='active'"; }?>><a  href="{{ url('/invoiceList/maid') }}">Maid Invoice</a></li> 
          </ul> </li>
          </ul>
          ...
          <!--<li {{ (Request::is('users*') ? 'class="active"' : '') }}>
            <a href="/service/"  @if(Request::is('service*')) {{'class=active'}} @else '' @endif>Services</a>
					...
					<li {{ (Request::is('users*') ? 'class="active"' : '') }}>
						<a href="{{ url('/page/') }}"  @if(Request::is('page*')) {{'class=active'}} @else '' @endif><i class="fa fa-tags"></i> Static Pages</a>
					</li>
          
					 <li {{ (Request::is('users*') ? 'class="active"' : '') }}>
						<a href="{{ url('/template/') }}"  @if(Request::is('template*')) {{'class=active'}} @else '' @endif><i class="fa fa-cogs"></i>Forms Templates</a>
					</li>
				@endif
