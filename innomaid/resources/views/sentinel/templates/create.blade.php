...
<h3 style='margin-left:10px;'>Add template</h3>
<hr/>
<div class="panel-body" style="">
      {!! Form::open(array('route' => 'template.store' ,'enctype'=>'multipart/form-data')) !!}
                ...
                <div class="row" style="max-width: 100%;">
                    ...
                    <div class="col-xs-7">
                       <textarea rows="10" cols="10" id='content' name="content" style="width: 645px; height: 150px;" placeholder="Write your content.." class="ckeditor"></textarea>
