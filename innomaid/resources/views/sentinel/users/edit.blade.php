...
twelvehour: true,
    ...
    {  var val = [];
        var validate = 0;
        var msg =''; 
        $('.operating_day:checked').each(function(i){//return false;
            var id = $(this).val();
            if($('.'+id+'from').val()=='' && $('.'+id+'to').val()==''){
                ...
                var fromtime = $('.'+id+'from').val(); //alert(msg);
                var fromhours = Number(fromtime.match(/^(\d+)/)[1]);
                var fromminutes = Number('00'); 
		suffix = fromtime.substr(-2);// alert(suffix);
                var fromAMPM = suffix;
...
<?php //echo "<pre>"; print_r($user);
    ...
    if ($isProfileUpdate) {
        ...
        if(isset($_GET['userid'])){
            $passwordFormAction = route('sentinel.password.change', $_GET['userid']);
        }else{
            $passwordFormAction = route('sentinel.password.change', $user->id);
        }
    }
...
<div id="tabs">
    <ul>
    @if (Auth::user()->hasRole('admin')||(Auth::user()->hasRole('user')&&$user->id==Auth::user()->id))
   ...
   @endif
    ...
    <div id="tabs-1">
        <form method="POST" action="{{ route('sentinel.users.update',['id'=>$user->id]) }}" enctype='multipart/form-data' accept-charset="UTF-8" >
          ...
          <div class="row">
                   ...
                   <label for="right-label" class="">Agency Name: <span class="mandatory">*</span> </label>
                    @endif
                        ...
                        <div class="small-9 columns {{ ($errors->has('company_name')) ? 'error' : '' }}">
                            <input placeholder="Agency Name" name="company_name" type="text" value="<?php echo $user->company_name;?>">
			...
			<input type='text' name='operating_hrs_from[]' value=' <?php echo $monfrom; ?>' class='field Mondayfrom hourfrom' onchange='return checkday("Monday","Mondayfrom")'>
                    ...
                    <div class="small-4 columns">
			 <input type='text' name='operating_hrs_to[]'  value=' <?php echo $monto; ?>' class = 'field Mondayto hourto' onchange='return checkday("Monday","Mondayto")'>
                ...
                <div class="small-7 columns">
                 <div class="small-2 columns">
                  ...
                  <div class="small-4 columns">
			 <input type='text' name='operating_hrs_from[]'  value=' <?php echo $tuefrom; ?>' class = 'field Tuesdayfrom hourfrom' onchange='return checkday("Tuesday","Tuesdayfrom")'>
                    ...
                    <div class="small-4 columns">
		 <input type='text' name='operating_hrs_to[]' value=' <?php echo $tueto; ?>' class = 'field Tuesdayto hourto' onchange='return checkday("Tuesday","Tuesdayto")'>
                    {!! ($errors->has('operating_hrs_to') ? $errors->first('operating_hrs_to', '<small class="error">:message</small>') : '') !!}
                    </div>
                </div>
			...
			<input type='text' name='operating_hrs_from[]' value=' <?php echo $wedfrom; ?>' class = 'field Wednesdayfrom hourfrom' onchange='return checkday("Wednesday","Wednesdayfrom")'>
                    ...
                    <div class="small-4 columns {{ ($errors->has('operating_hrs')) ? 'error' : '' }}">
		 <input type='text' name='operating_hrs_to[]' value=' <?php echo $wedto; ?>' class ='field Wednesdayto hourto' onchange='return checkday("Wednesday","Wednesdayto")'>
                ...
                <div class="small-7 columns">
                 <div class="small-2 columns">
                  ...
                  <div class="small-4 columns {{ ($errors->has('operating_hrs')) ? 'error' : '' }}">
		<input type='text' name='operating_hrs_from[]' value=' <?php echo $thrfrom; ?>' class = 'field Thrusdayfrom hourfrom' onchange='return checkday("Thrusday","Thrusdayfrom")'>
                    {!! ($errors->has('operating_hrs_from') ? $errors->first('operating_hrs_from', '<small class="error">:message</small>') : '') !!}
                    </div> 
                    <div class="small-2 columns">
                    <label for="right-label" class="">To:</label>
                    ...
                    <div class="small-4 columns">
		 <input type='text' name='operating_hrs_to[]'  value=' <?php echo $thrto; ?>'  class = 'field Thrusdayto hourto' onchange='return checkday("Thrusday","Thrusdayto")'>
                    {!! ($errors->has('operating_hrs_to') ? $errors->first('operating_hrs_to', '<small class="error">:message</small>') : '') !!}
                    </div>
                </div>
                ...
                <div class="small-7 columns">
                 <div class="small-2 columns">
                  ...
                  <div class="small-4 columns {{ ($errors->has('operating_hrs')) ? 'error' : '' }}">
		  <input type='text' name='operating_hrs_from[]'  value=' <?php echo $frifrom; ?>' class = 'field Fridayfrom hourfrom' onchange='return checkday("Friday","Fridayfrom")'>
                    {!! ($errors->has('operating_hrs_from') ? $errors->first('operating_hrs_from', '<small class="error">:message</small>') : '') !!}
                    </div> 
                    <div class="small-2 columns">
                    <label for="right-label" class="">To:</label>
                    ...
                    <div class="small-4 columns ">
			<input type='text' name='operating_hrs_to[]' value=' <?php echo $frito; ?>'  class = 'field Fridayto hourto' onchange='return checkday("Friday","Fridayto")'>
                ...
                <div class="small-7 columns">
                 ...
                 <div class="small-2 columns">
                  ...
                  <div class="small-4 columns">
			 <input type='text' name='operating_hrs_from[]' value=' <?php echo $satfrom; ?>'   class ='field Saturdayfrom hourfrom' onchange='return checkday("Saturday","Saturdayfrom")'>
                    {!! ($errors->has('operating_hrs_from') ? $errors->first('operating_hrs_from', '<small class="error">:message</small>') : '') !!}
                    </div> 
                    <div class="small-2 columns">
                    <label for="right-label" class="">To:</label>
                    ...
                    <div class="small-4 columns">
			 <input type='text' name='operating_hrs_to[]'  value=' <?php echo $satto; ?>' class = 'field Saturdayto hourto' onchange='return checkday("Saturday","Saturdayto")'>
                    {!! ($errors->has('operating_hrs_to') ? $errors->first('operating_hrs_to', '<small class="error">:message</small>') : '') !!}
                    </div>
                </div>
                ...
                <div class="small-7 columns">
                 ...
                 <div class="small-2 columns">
                  ...
                  <div class="small-4 columns">
		<input type='text' name='operating_hrs_from[]' value=' <?php echo $sunfrom; ?>' class= 'field Sundayfrom hourfrom' onchange='return checkday("Sunday","Sundayfrom")'>
                    {!! ($errors->has('operating_hrs_from') ? $errors->first('operating_hrs_from', '<small class="error">:message</small>') : '') !!}
                    </div> 
                    <div class="small-2 columns">
                    <label for="right-label" class="">To:</label>
                    ...
                    <div class="small-4 columns ">
		<input type='text' name='operating_hrs_to[]'  value=' <?php echo $sunto; ?>' class = 'field Sundayto hourto' onchange='return checkday("Sunday","Sundayto")'>
                    {!! ($errors->has('operating_hrs_to') ? $errors->first('operating_hrs_to', '<small class="error">:message</small>') : '') !!}
                    </div>          
                </div>
                <div class="small-3 columns">
		...
		@if(Auth::user()->hasRole('user'))
			<div class="row">
                ...
                <div class="small-9 columns {{ ($errors->has('registration_number')) ? 'error' : '' }}">
                    <input placeholder="" name="registration_number" type="text" value="<?php echo $user->registration_number;?>" autocomplete ='off'>
                                    ...
                                    @if($agencycontacts)
                                      @foreach ($agencycontacts as $agencycontactsid => $agencycontactsvalue)
                                        ...
                                        <tr>
                                            ...
                                            @if(isset($_GET['userid']))
                                            <td><a href="{{  url('/users/'.$agencycontactsvalue->agency_id.'/agencycontactsdelete/'.$agencycontactsvalue->id.'?userid='.$_GET['userid'])}}" onclick="return confirmdelete();">
    ...
    <div id="tabs-3">
        <form method="POST" action="{{ $passwordFormAction }}" accept-charset="UTF-8" class="form-inline" role="form">
            <input type="hidden" value="{{$user->id}}" name='agencyid'>
            <div class="row">
