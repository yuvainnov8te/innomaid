...
<h3 style='margin-left:10px;'>Edit Package</h3>
<hr/>
	<div class="panel-body" style="">
      {!! Form::model($package,array('route' => array('sentinel.package.update', $package->id),'enctype'=>'multipart/form-data')) !!}
                ...
                <div class="row" style="max-width: 100%;">
                    ...
                    <div class="col-xs-7">
                       <textarea rows="10" cols="10" id='content' name="package_description" style="width: 645px; height: 150px;" placeholder="Write your content.." >{{$package->package_description}}</textarea>
