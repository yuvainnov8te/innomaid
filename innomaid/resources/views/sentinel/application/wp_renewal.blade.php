...
<div id="tabs">
    <ul>
	  ...
	  <li> <a onclick="return getauthorisation()" href="#tabs-9"  style=" padding: 0.3em 0.6em;"><span style="font-size:0.8em"> Authorisation Work Pass Transaction</span></a></li>  
	   <li><a href="#tabs-10"  onclick="return getsecuritybond()"  style=" padding: 0.3em 0.6em;"><span style="font-size:0.8em"> Security Bond </span></a></li>  
...
<div id="tabs-16">
{!! Form::model($workpermit,array('route' => array('sentinel.application.wp_renewalupdate', $maid_employer->id))) !!}
	<div class="row">	
		<div class="small-8 columns">
                    <p><span class="mandatory">*</span> Fields are required</p>
        </div> <div class="small-1 columns" style="float:right">
       <a  class="fa fa-download" title="Pdf" href="{{url('/application/'.$maid_employer->id.'/show_wp_renewal/yes')}}">          </a></div></div>
<div class="row">
		<div class="col-md-4">
			<label for="SB Transmission No">Policy Number :</label>
		</div> 
		<div class="col-xs-4">
			{!! Form::text('policy_number',null, ['class'=> 'form-control']) !!}
			 {!! ($errors->has('policy_number') ? $errors->first('policy_number', '<small class="error">:message</small>') : '') !!}
		</div>
		</div>
<div class="row">
		<div class="col-md-4">
			<label for="SB Transmission No">Expiry Date :</label>
		</div> 
		<div class="col-xs-4">
			{!! Form::text('expiry_date',null, ['class'=> 'form-control datetimepicker','data-date-format'=>"yyyy-mm-dd"]) !!}
			 {!! ($errors->has('expiry_date') ? $errors->first('expiry_date', '<small class="error">:message</small>') : '') !!}
		</div>
		</div>
