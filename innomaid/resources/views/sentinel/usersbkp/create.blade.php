        ...
        <div class="small-10 large-centered columns">
            ...
            <div class="row">
                ...
                <div class="small-9 columns {{ ($errors->has('company_name')) ? 'error' : '' }}">
                    <input placeholder="Company name" name="company_name" type="text" value="{{ Input::old('company_name') }}">
            ...
            <div class="row">
                <div class="small-3 columns">
                    <label for="right-label" class="">Confirm:<span class="mandatory">*</span></label>
                </div>
                <div class="small-9 columns">
             ...
             <div class="row">
                ...
                <?php 
                 ...
                 <div class="small-2 columns">
                  ...
                  <div class="small-4 columns">
                    {!! Form::select('operating_hrs_from[]',$hours ,null,['class' => 'field Mondayfrom hourfrom','onchange'=>'return checkday("Monday","Mondayfrom")']) !!}
                    ...
                    <div class="small-4 columns">
                     {!! Form::select('operating_hrs_to[]',$hours ,null,['class' => 'field Mondayto hourto','onchange'=>'return checkday("Monday","Mondayto")']) !!}
                ...
                <div class="small-7 columns">
                 <div class="small-2 columns">
                  ...
                  <div class="small-4 columns">
                    {!! Form::select('operating_hrs_from[]',$hours ,null,['class' => 'field Tuesdayfrom hourfrom','onchange'=>'return checkday("Tuesday","Tuesdayfrom")']) !!}
                    {!! ($errors->has('operating_hrs_from') ? $errors->first('operating_hrs_from', '<small class="error">:message</small>') : '') !!}
                    </div> 
                    <div class="small-2 columns">
                    <label for="right-label" class="">To:</label>
                    ...
                    <div class="small-4 columns">
                     {!! Form::select('operating_hrs_to[]',$hours ,null,['class' => 'field Tuesdayto hourto','onchange'=>'return checkday("Tuesday","Tuesdayto")']) !!}
                    {!! ($errors->has('operating_hrs_to') ? $errors->first('operating_hrs_to', '<small class="error">:message</small>') : '') !!}
                    </div>
                </div>
                ...
                <div class="small-7 columns">
                 <div class="small-2 columns">
                  ...
                  <div class="small-4 columns">
                    {!! Form::select('operating_hrs_from[]',$hours ,null,['class' => 'field Wednesdayfrom hourfrom','onchange'=>'return checkday("Wednesday","Wednesdayfrom")']) !!}
                    {!! ($errors->has('operating_hrs_from') ? $errors->first('operating_hrs_from', '<small class="error">:message</small>') : '') !!}
                    </div> 
                    <div class="small-2 columns">
                    ...
                    <div class="small-4 columns">
                     {!! Form::select('operating_hrs_to[]',$hours ,null,['class' => 'field Wednesdayto hourto','onchange'=>'return checkday("Wednesday","Wednesdayto")']) !!}
                    {!! ($errors->has('operating_hrs_to') ? $errors->first('operating_hrs_to', '<small class="error">:message</small>') : '') !!}
                    </div>
                </div>
                ...
                <div class="small-7 columns">
                 <div class="small-2 columns">
                  ...
                  <div class="small-4 columns">
                    {!! Form::select('operating_hrs_from[]',$hours ,null,['class' => 'field Thrusdayfrom hourfrom','onchange'=>'return checkday("Thrusday","Thrusdayfrom")']) !!}
                    {!! ($errors->has('operating_hrs_from') ? $errors->first('operating_hrs_from', '<small class="error">:message</small>') : '') !!}
                    </div> 
                    <div class="small-2 columns">
                    <label for="right-label" class="">To:</label>
                    ...
                    <div class="small-4 columns">
                     {!! Form::select('operating_hrs_to[]',$hours ,null,['class' => 'field Thrusdayto hourto','onchange'=>'return checkday("Thrusday","Thrusdayto")']) !!}
                    {!! ($errors->has('operating_hrs_to') ? $errors->first('operating_hrs_to', '<small class="error">:message</small>') : '') !!}
                    </div>
                </div>
                ...
                <div class="small-7 columns">
                 <div class="small-2 columns">
                  ...
                  <div class="small-4 columns">
                    {!! Form::select('operating_hrs_from[]',$hours ,null,['class' => 'field Fridayfrom hourfrom','onchange'=>'return checkday("Friday","Fridayfrom")']) !!}
                    {!! ($errors->has('operating_hrs_from') ? $errors->first('operating_hrs_from', '<small class="error">:message</small>') : '') !!}
                    </div> 
                    <div class="small-2 columns">
                    <label for="right-label" class="">To:</label>
                    ...
                    <div class="small-4 columns">
                     {!! Form::select('operating_hrs_to[]',$hours ,null,['class' => 'field Fridayto hourto','onchange'=>'return checkday("Friday","Fridayto")']) !!}
                    {!! ($errors->has('operating_hrs_to') ? $errors->first('operating_hrs_to', '<small class="error">:message</small>') : '') !!}
                    </div>
                </div>
                ...
                <div class="small-7 columns">
                 ...
                 <div class="small-2 columns">
                  ...
                  <div class="small-4 columns">
                    {!! Form::select('operating_hrs_from[]',$hours ,null,['class' => 'field Saturdayfrom hourfrom','onchange'=>'return checkday("Saturday","Saturdayfrom")']) !!}
                    {!! ($errors->has('operating_hrs_from') ? $errors->first('operating_hrs_from', '<small class="error">:message</small>') : '') !!}
                    </div> 
                    <div class="small-2 columns">
                    <label for="right-label" class="">To:</label>
                    ...
                    <div class="small-4 columns">
                     {!! Form::select('operating_hrs_to[]',$hours ,null,['class' => 'field Saturdayto hourto','onchange'=>'return checkday("Saturday","Saturdayto")']) !!}
                    {!! ($errors->has('operating_hrs_to') ? $errors->first('operating_hrs_to', '<small class="error">:message</small>') : '') !!}
                    </div>
                </div>
                ...
                <div class="small-7 columns">
                 ...
                 <div class="small-2 columns">
                  ...
                  <div class="small-4 columns">
                    {!! Form::select('operating_hrs_from[]',$hours ,null,['class' => 'field Sundayfrom hourfrom','onchange'=>'return checkday("Sunday","Sundayfrom")']) !!}
                    {!! ($errors->has('operating_hrs_from') ? $errors->first('operating_hrs_from', '<small class="error">:message</small>') : '') !!}
                    </div> 
                    <div class="small-2 columns">
                    <label for="right-label" class="">To:</label>
                    ...
                    <div class="small-4 columns">
                     {!! Form::select('operating_hrs_to[]',$hours ,null,['class' => 'field Sundayto hourto','onchange'=>'return checkday("Sunday","Sundayto")']) !!}
                    {!! ($errors->has('operating_hrs_to') ? $errors->first('operating_hrs_to', '<small class="error">:message</small>') : '') !!}
                    </div>
                </div>
                 <div class="small-3 columns">
...
@if (Auth::user()->hasRole('admin'))
<div id="tabs-2">
    <form method="POST" action="{{ route('sentinel.users.create') }}" accept-charset="UTF-8">
  <div class="row">
        <div class="small-8 large-centered columns">
            ...
            <div id="contactcontent">
                <div id="addcontact0">
                    <div class="row">
                        <div class="small-3 columns">
                            <label for="right-label" class="">Contact Name 1:<span class="mandatory">*</span> </label>
                        </div>
                        <div class="small-9 columns {{ ($errors->has('contact_name')) ? 'error' : '' }}">
                            <input placeholder="" name="contact_name" type="text" value="{{ Input::old('contact_name') }}">
                            {!! ($errors->has('contact_name') ? $errors->first('contact_name', '<small class="error">:message</small>') : '') !!}
                        </div>
                    </div>

                    <div class="row">
                        <div class="small-3 columns">
                            <label for="right-label" class="">Contact Number 1: <span class="mandatory">*</span> </label>
                        </div>
                        <div class="small-9 columns {{ ($errors->has('contact_no')) ? 'error' : '' }}">
                            <input placeholder="" name="contact_no" type="text" value="{{ Input::old('contact_no') }}">
                            {!! ($errors->has('contact_no') ? $errors->first('contact_no', '<small class="error">:message</small>') : '') !!}
                        </div>
                    </div>
                </div>
                <div id="addcontact1"></div>
              </div>  
              <a id="add_row_contact" class="btn btn-default pull-left">Add More</a><a id='delete_row_contact' class="pull-right btn btn-default">Remove</a>
             <br /><br />
             <div class="row text-center">
                <div class="small-10 small-offset-2 columns">
                    <input name="_token" value="{{ csrf_token() }}" type="hidden">
                    <input class="button small" value="Create" type="submit">
                    {!! Form::reset('Reset', array('class' => 'button small')) !!}
                    <button onclick="window.location='{{ url("users") }}'" class="button small" type="button" id="cancel" name="cancel">Go To List</button>
                </div>
            </div>
