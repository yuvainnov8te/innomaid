...
<div class="panel-body" style="background-color:#f0f2f7;">
      {!! Form::model($role,  array('route' => array('sentinel.role.update', $role[0]->id)) ) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5 {{ ($errors->has('name')) ? 'error' : '' }}">
                        {!! Form::text('name', $role[0]->name, ['class'=> 'form-control']) !!}
                ...
                <div class="row" style="max-width: 100%;">
                    ...
                    <div class="col-xs-5">
                       {!! Form::text('display_name', $role[0]->display_name, ['class'=> 'form-control']) !!}
                ...
                <div class="row">
                   ...
                   <div class="col-xs-5">
                       {!! Form::text('description', $role[0]->description, ['class'=> 'form-control']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5">
                    @if($role[0]->display == 1)
                        <input name="display" value="1" type="checkbox" checked="checked">
                    @else($role[0]->display == 0)
