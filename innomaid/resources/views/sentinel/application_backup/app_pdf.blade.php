...
<body style="background:white;">
	...
	@if($user_data[0]->agency_logo)
		...
		<table class="table table-bordered per_info">
			<tbody>
					...
					<tr>
					<td><span>License No. :</span><span style="font-weight:500; padding-left:5px;">@if($user_data[0]->license_no != '')
					{{$user_data[0]->license_no}}
					@else
					{{ '-' }}
					@endif</span></td>
					<td><span style="padding-left: 30px;font-weight:bold;">Reference No. :</span></td>
			   </tr>
			</tbody>
		</table>
	...
	<span align="left"style="font-weight:bold;font-size:11px; padding-top:0px !important;border-bottom:1px solid #000;">Particulars of Parties</span>
		...
		<table class="table table-bordered fdw_info">
			<tbody>
				<tr>
					<td>The Employer</td></tr>
					<tr><td><span>Full Name:</span><span style="font-weight:500; padding-left:5px;">@if($employer_details[0]->employer_name!= '')
					{{$employer_details[0]->employer_name}}
					@else
					{{ '-' }}
					@endif
					</span></td>
					...
					{{$employer_details[0]->employer_nric_no}}/{{$employer_details[0]->employer_passport}}
					@else
					{{ '-' }}
					@endif</span></td>
			   </tr>
		...
		<table class="table table-bordered fdw_info" >
			<tbody>
				<tr>
					<td>The Foreign Domestic Worker (FDW)</td></tr>
					<tr><td><span>Full Name:</span><span style="font-weight:500; padding-left:5px;">@if($maid_details[0]->name!= '')
					{{$maid_details[0]->name}}
					@else
					{{ '-' }}
					@endif
					</span></td>
					<td><span style="padding-left: 30px;font-weight:bold;">Passport No. :</span><span style="font-weight:500; padding-left:5px;">--</span></td>
			   </tr>
			</tbody>
		</table>
		...
		<ul style="margin-top:15px;">
			@if(in_array("Household chores", $domestic_duty_val))
				<li style="list-style-type:none;"><img height='15px' src="<?php echo $root_path."/public/img/cheked.jpg";?>">Household chores</li>
			@else
				<li style="list-style-type:none;"><img height='15px' src="<?php echo $root_path."/public/img/blank.jpg";?>">Household chores</li>
			@endif
			@if(in_array("Cooking", $domestic_duty_val))
				<li style="list-style-type:none;"><img height='15px' src="<?php echo $root_path."/public/img/cheked.jpg";?>">Cooking</li>
			@else
				<li style="list-style-type:none;"><img height='15px' src="<?php echo $root_path."/public/img/blank.jpg";?>">Cooking</li>
			@endif
			@if(in_array("Looking after aged person", $domestic_duty_val))
				<li style="list-style-type:none;"><img height='15px' src="<?php echo $root_path."/public/img/cheked.jpg";?>">Looking after aged person(s) in the household [constant attention is *required/not required]</li>
			@else
				<li style="list-style-type:none;"><img height='15px' src="<?php echo $root_path."/public/img/blank.jpg";?>">Looking after aged person(s) in the household [constant attention is *required/not required]</li>
			@endif
			@if(in_array("Baby-sitting", $domestic_duty_val))
				<li style="list-style-type:none;"><img height='15px' src="<?php echo $root_path."/public/img/cheked.jpg";?>">Baby-sitting</li>
			@else
				<li style="list-style-type:none;"><img height='15px' src="<?php echo $root_path."/public/img/blank.jpg";?>">Baby-sitting</li>
			@endif
				@if(in_array("Child-minding", $domestic_duty_val))
				<li style="list-style-type:none;"><img height='15px' src="<?php echo $root_path."/public/img/cheked.jpg";?>">Child-minding</li>
			@else
				<li style="list-style-type:none;"><img height='15px' src="<?php echo $root_path."/public/img/blank.jpg";?>">Child-minding</li>
			@endif
			@if($maid_job_data[0]->other_duty != '')
				<li style="list-style-type:none;"><span><img height='15px' src="<?php echo $root_path."/public/img/cheked.jpg";?>">Others:</span><span style="font-weight:500; margin-left:5px;border-bottom:1px solid #000;">{{$maid_job_data[0]->other_duty}}</span></li>
			@endif
		</ul>
		<h1 style="font-weight:bold;font-size:11px;padding-top:25px;">Place of work (to tick where applicable) </h1>
		<p style="margin-top:15px;">a)<span style ="padding-left:30px;"> House Type:</span></p>
		...
		<ul>
			@if(in_array("Landed Property", $place_work_val))
				<li style="list-style-type:none;"><img height='15px' src="<?php echo $root_path."/public/img/cheked.jpg";?>">Landed Property</li>
			@else
				<li style="list-style-type:none;"><img height='15px'src="<?php echo $root_path."/public/img/blank.jpg";?>">Landed Property</li>
			@endif
			@if(in_array("Condominium/Private Apartment", $place_work_val))
				<li style="list-style-type:none;"><img height='15px'src="<?php echo $root_path."/public/img/cheked.jpg";?>">Condominium/Private Apartment</li>
			@else
				<li style="list-style-type:none;"><img height='15px'src="<?php echo $root_path."/public/img/blank.jpg";?>">Condominium/Private Apartment</li>
			@endif
			@if(in_array("HDB 5-rooms or larger", $place_work_val))
				<li style="list-style-type:none;"><img height='15px' src="<?php echo $root_path."/public/img/cheked.jpg";?>">HDB 5-rooms or larger</li>
			@else
				<li style="list-style-type:none;"><img height='15px' src="<?php echo $root_path."/public/img/blank.jpg";?>">HDB 5-rooms or larger</li>
			@endif
			@if($maid_job_data[0]->no_rooms != '')
				<li style="list-style-type:none;"><img height='15px'src="<?php echo $root_path."/public/img/cheked.jpg";?>">HDB {{$maid_job_data[0]->no_rooms}} -Room Flat(specify no. of rooms)</li>
			@endif
			@if($maid_job_data[0]->other_work_place != '')
				<li style="list-style-type:none;"><span><img height='15px' src="<?php echo $root_path."/public/img/cheked.jpg";?>">Others:</span> <span style="border-bottom:1px solid #000;">{{$maid_job_data[0]->other_work_place}}</span></li>
			@endif
				
		</ul>
		@if($maid_job_data[0]->bedrooms != '')
		<p style="padding-left:5px;">b)<span style ="padding-left:30px;"> Number of Bedrooms in the house:</span><span>{{$maid_job_data[0]->bedrooms}}</span> </p>
		@endif
	</div>
</body>
</html>