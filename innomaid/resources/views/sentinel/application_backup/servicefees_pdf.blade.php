...
<body style="background:white;">
  ...
  @if($agency_detail[0]->agency_logo)
		<div style="width:100px; height:100px;">
				<img style = "height:100px; width:100px;"src='<?php echo $root_path."/uploads/agency_logo/".$agency_detail[0]->agency_logo;?>' />
		</div>
		@endif
		...
		<table class="table table-bordered maid_info" width="80%"> 
			<tbody>      
				...
				<tr>
					...
					<td>{{$maid_details[0]->passport_number}}</td>
					@else
						<td>-</td>
					@endif
				</tr>
				...
				<tr>
					...
					<td>{{$replaced_maid[0]->passport_number}}</td>
					@else
						<td>-</td>
					@endif
				</tr>
...
<table class="table table-bordered per_info" style="margin-top:0px !important;">
			...
			<tr>
				...
				<td>					
					<span><span style="border-bottom:1px solid #000; margin-left:25px;">{{$replacement_cost_value->replacement_number}}</span>
							replacement within
						<span style="border-bottom:1px solid #000;">{{$replacement_cost_value->replacement_month}}</span>
							months
						<span style="border-bottom:1px solid #000;">{{$replacement_cost_value->cost}}</span>
					 </span>
	...
	<tr>
		...
		<td  style="font-weight:bold;">{{$total_package_fee}}</td>
	</tr>
</table>
	...
	<table class="table table-bordered" style="line-height:1.50;margin-top:0px;">
	  <tr>
		...
		@if($servicefees[0]->deposite)
			<span style="border-bottom:1px solid #000;">{{$servicefees[0]->deposite}}</span>
		@else 
	  ...
	  <tr>
		...
		@if($servicefees[0]->final_payment)
			<span style="border-bottom:1px solid #000;">{{$servicefees[0]->final_payment}}</span> 
		@else 
			<span style="border-bottom:1px solid #000;padding-right:155px;">&nbsp;</span> 
		@endif</td>
	  </tr>
	...
	<table class="table table-bordered per_info" style="line-height:1.50;margin-top:0px !important;">
		...
		<tr>
				...
				<td style="font-weight:bold;">{{$totalplacprice}}</td>
		</tr>
	</table>
	...
	<td style="padding-top:5px;"><img  height="15px" width="15px"src="<?php echo $root_path."/public/img/cheked.jpg";?>">Upfront Placement Fee and post dated cheques</td></tr>
		 <tr> <td>
		 <span><span style="margin-left:35px;border-bottom:1px solid #000;">{{$servicefees[0]->upfront_month}} </span>months upfront Placement Fee<span style="border-bottom:1px solid #000;"> {{$servicefees[0]->upfront_fee}}.</span>
		 </span>
		  </td></tr>
	...
	@if($servicefees[0]->payment_placement_fee == "Full sum payable")
		<tr><td><img  height="15px" width="15px"src="<?php echo $root_path."/public/img/cheked.jpg";?>"><span style ="padding-top:5px;">Full sum payable upon *handover / signing of contract / others: <span style="margin-left:5px;border-bottom:1px solid #000;">{{$servicefees[0]->placement_full_sum}}</span></span></td></tr>
	@else
	...
	@if($servicefees[0]->payment_placement_fee == "Others")
		<tr><td><span style ="padding-top:5px;"><img  height="15px" width="15px"src="<?php echo $root_path."/public/img/cheked.jpg";?>">Others:<span style ="margin-left:5px;border-bottom:1px solid #000;">{{$servicefees[0]->placement_other}}</span></span></td></tr>
	@else
